...
import org.skr.gx2d.ModelEditor.ApplicationSettings;
...
public class DialogNodeScriptSourceEditor extends JDialog {
    ...
    protected NodeScriptProvider provider;
    ...
    public DialogNodeScriptSourceEditor() {
    ...
    public boolean execute(NodeScript script, NodeScriptProvider provider ) {
        this.script = script;
