...
public class MainGui extends JFrame {
    ...
    private Gx2dJTreeNode jointsGroupNode;
    private Gx2dJTreeNode bodiesGroupNode;

    private ModelGuiControl modelStructureGuiProcessing;
    ...
    MainGui() {
        ...
        modelStructureGuiProcessing = new ModelGuiControl( this );
...
//        updateJointCombos();
    ...
    void updateJointItem() {
        ...
        JointItem ji = formJointEditor.getJointHandler();
        ...
        JointItemFactory.loadFromDescription( ji, formJointEditor.getJointHandlerDefinition() );
        if ( ji.getJoint() == null ) {
